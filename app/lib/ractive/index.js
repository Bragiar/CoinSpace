...
partials.svg_contact = require('lib/svg/pawn.ract')
partials.svg_trace_continue = require('lib/svg/trace_continue.ract')
partials.svg_trace_create= require('lib/svg/trace_create.ract')
