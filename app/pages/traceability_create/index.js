...
module.exports = function(el) {
    ...
    ractive.on('select-contact', function() {
    ...
    function validateAndShowConfirm(to, alias, dynamicFees, amount) {
        ...
        var untr = getTraceabilityUnspents()
        console.log(untr)
        ...
        validateSend(wallet, to, amount, text, dynamicFees, unspents_traceandfee, function(err) {
            ...
            showConfirmation({
                to: to,
                alias: alias,
                amount: 10, // don't change this to amount. 'value' could be modified above
                text: text,
                contact: ractive.get('selectedContact'),
                isTraceability: true,
                batchNum: ractive.find('#batch').value,
